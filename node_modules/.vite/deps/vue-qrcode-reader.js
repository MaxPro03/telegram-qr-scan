...
var Cr = (r, o, i) => (Ar(r, o, "read from private field"), i ? i.call(r) : o.get(r));
var wo = (r, o, i) => {
  if (o.has(r))
    throw TypeError("Cannot add the same private member more than once");
  o instanceof WeakSet ? o.add(r) : o.set(r, i);
};
var bo = (r, o, i, c) => (Ar(r, o, "write to private field"), c ? c.call(r, i) : o.set(r, i), i);
var Dr = [
  ["aztec", "Aztec"],
  ["code_128", "Code128"],
  ["code_39", "Code39"],
...
var ut = (() => {
  ...
  return function(o = {}) {
    ...
    var U, W = false, x, D, X, k, M, A, le, oe;
    function be() {
      var e = U.buffer;
    ...
    var Ne = [], ze = 0, an = (e) => {
      var t = new wt(e);
      return t.get_caught() || (t.set_caught(true), ze--), t.set_rethrown(false), Ne.push(t), pr(t.excPtr), t.get_exception_ptr();
    }, ie = 0, on = () => {
      j(0, 0);
      var e = Ne.pop();
      hr(e.excPtr), ie = 0;
    ...
    var sn = (e) => {
      ...
      var t = e.excPtr;
      throw e.get_rethrown() || (Ne.push(e), e.set_rethrown(true), e.set_caught(false), ze++), ie = t, ie;
    }, fn = (e, t, n) => {
      var a = new wt(e);
    ...
    var ke = (e) => typeof FinalizationRegistry > "u" ? (ke = (t) => t, e) : (St = new FinalizationRegistry((t) => {
      ...
      Object.assign(Qe.prototype, {
        ...
        deleteLater() {
          return this.$$.ptr || _t(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && R("Object already scheduled for deletion"), De.push(this), De.length === 1 && Re && Re(Pt), this.$$.deleteScheduled = true, this;
        }
      });
    };
    function Qe() {
...
var je;
var lt = class extends EventTarget {
  constructor(o = {}) {
    var i;
...
var Pr = (r) => new Promise((o) => setTimeout(o, r));
...
var Nr = async (r, o = ["qr_code"]) => await new lt({
  formats: o
}).detect(r);
var ti = async (r, o = ["qr_code"]) => {
  const i = new lt({
    formats: o
  }), c = await ei(r);
...
function ni(r, o, i) {
  return o = ai(o), o in r ? Object.defineProperty(r, o, { value: i, enumerable: true, configurable: true, writable: true }) : r[o] = i, r;
}
function ai(r) {
  var o = oi(r, "string");
...
function Mi(r) {
  ...
  r.RTCPeerConnection.prototype.createOffer = function(c) {
    if (c) {
      ...
      c.offerToReceiveAudio === false && d ? d.direction === "sendrecv" ? d.setDirection ? d.setDirection("sendonly") : d.direction = "sendonly" : d.direction === "recvonly" && (d.setDirection ? d.setDirection("inactive") : d.direction = "inactive") : c.offerToReceiveAudio === true && !d && this.addTransceiver("audio", {
        direction: "recvonly"
...
async function Or(r, o, i) {
  ...
  let v = false;
  return i && h.torch && (await d.applyConstraints({ advanced: [{ torch: true }] }), v = true), {
    type: "start",
    data: {
      videoEl: r,
      stream: c,
...
var ki = defineComponent({
  ...
  setup(r, { emit: o }) {
    const i = r, c = o, d = ref(i.constraints), h = ref(i.formats);
    watch(
      () => i.constraints,
      (k, M) => {
